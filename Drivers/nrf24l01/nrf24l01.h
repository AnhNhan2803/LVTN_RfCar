...
#define NEF24L01_EXIT_POWER_DONW_ENABLE         (0x02)
#define NEF24L01_EXIT_POWER_DONW_DISABLE        (0x00)
...
#define NEF24L01_RF_TX_PWR_MASK                 (~(0x01))
...
#define NRF24L01_INT_RX_DR_ENABLE               (0x40)   
#define NRF24L01_INT_TX_DS_MASK                 (~(0x20))     
#define NRF24L01_INT_TX_DS_ENABLE               (0x20)   
#define NRF24L01_INT_MAX_RT_MASK                (~(0x10))     
#define NRF24L01_INT_MAX_RT_ENABLE              (0x10)   
...
typedef enum {
    NRF24L01_TX_PWR_NEG_18dBm = 0x00,
    NRF24L01_TX_PWR_NEG_12dBm,
    NRF24L01_TX_PWR_NEG_6dBm,
    NRF24L01_TX_PWR_NEG_0dBm
} nrf24l01_tx_pwr_t;
